...
$formdata=array('firstName'=> $firstName,'lastname'=> $lastName,'gender'=> $Gender, 'email'=> $Email, 'username'=> $userName, 'password'=> $password, 'rmail'=> $rMail,
		);

		$existingdata=file_get_contents('file.txt');
